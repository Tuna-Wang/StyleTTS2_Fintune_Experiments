...
The original StyleTTS2 provided jupyter notebooks for fine-tuning, the file is located in the Colab folder. However, you should make small modifications to add in your own training data.  
